/**
 * Markdown renderer. Adapted from packages/collab-web/src/components/transcript/Markdown.tsx
 * (same repo) to keep the desktop package standalone. XSS-safe: raw HTML is
 * escaped (never emitted), and link hrefs are restricted to safe schemes.
 */
