...
export const PROVIDER_CATALOG: readonly ProviderCatalogEntry[] = [
	...
	{ id: "huggingface", name: "Hugging Face", type: "api-key", envVars: ["HF_TOKEN", "HUGGING_FACE_HUB_TOKEN"] },
	...
	{ id: "wafer-serverless", name: "Wafer Serverless", type: "api-key", envVars: ["WAFER_API_KEY"] },
	{
		id: "perplexity",
		name: "Perplexity",
		type: "oauth",
	...
	{ id: "gitlab-duo", name: "GitLab Duo", type: "coding-plan" },
	...
	{ id: "minimax-code", name: "MiniMax Coding Plan", type: "coding-plan" },
	{ id: "minimax-code-cn", name: "MiniMax Coding Plan (CN)", type: "coding-plan" },
	{ id: "alibaba-coding-plan", name: "Alibaba Coding Plan", type: "coding-plan" },
	{ id: "qwen-portal", name: "Qwen Portal", type: "api-key", envVars: ["DASHSCOPE_API_KEY"] },
	{ id: "zai", name: "Z.AI / GLM Coding Plan", type: "coding-plan" },
	{ id: "zhipu-coding-plan", name: "Zhipu Coding Plan", type: "coding-plan" },
	{ id: "xiaomi", name: "Xiaomi MiMo", type: "api-key", envVars: ["XIAOMI_API_KEY"] },
	{ id: "xiaomi-token-plan-ams", name: "Xiaomi Token Plan (AMS)", type: "coding-plan" },
	{ id: "xiaomi-token-plan-cn", name: "Xiaomi Token Plan (CN)", type: "coding-plan" },
	{ id: "xiaomi-token-plan-sgp", name: "Xiaomi Token Plan (SGP)", type: "coding-plan" },
	{ id: "qianfan", name: "Qianfan", type: "api-key", envVars: ["QIANFAN_API_KEY"] },
	{ id: "nanogpt", name: "NanoGPT", type: "api-key", envVars: ["NANOGPT_API_KEY"] },
	...
	{ id: "opencode-go", name: "OpenCode Go", type: "coding-plan" },
	{ id: "opencode-zen", name: "OpenCode Zen", type: "coding-plan" },
	{ id: "devin", name: "Devin", type: "coding-plan" },
	{ id: "firepass", name: "Firepass", type: "api-key", envVars: ["FIREPASS_API_KEY"] },
	{ id: "openai-codex-device", name: "OpenAI Codex (device)", type: "oauth" },
	{ id: "sakana", name: "Sakana", type: "api-key", envVars: ["SAKANA_API_KEY"] },
	{ id: "umans", name: "Umans", type: "api-key", envVars: ["UMANS_API_KEY"] },
